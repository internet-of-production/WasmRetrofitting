...
function setHTMatrix(axisNumber:i32, axisValue:f64):void{
    if(axisNumber==1){
        ...
        let raw1:Array<f64> = [Math.cos(axisValue), 0, Math.sin(axisValue), 0]
        ...
        let raw1:Array<f64> = [Math.cos(axisValue), -Math.sin(axisValue), 0, 0]
        let raw2:Array<f64> = [Math.sin(axisValue), Math.cos(axisValue), 0, 0]
...
function matrixMultiplication(matrix1:Array<Array<f64>>,matrix2:Array<Array<f64>>):Array<Array<f64>>{
    ...
    let result:Array<Array<f64>> = [initArray.slice(0),initArray.slice(0),initArray.slice(0),initArray.slice(0)]
